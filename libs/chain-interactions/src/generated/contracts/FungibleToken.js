...
/**
* Method to generate cadence code for FungibleToken contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const FungibleTokenTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `FungibleToken =>`)
...
/**
* Deploys FungibleToken transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployFungibleToken = async (props) => {
  const { addressMap = {} } = props;
  const code = await FungibleTokenTemplate(addressMap);
