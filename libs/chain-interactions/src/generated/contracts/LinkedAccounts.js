...
/**
* Method to generate cadence code for LinkedAccounts contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const LinkedAccountsTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `LinkedAccounts =>`)
...
/**
* Deploys LinkedAccounts transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployLinkedAccounts = async (props) => {
  const { addressMap = {} } = props;
  const code = await LinkedAccountsTemplate(addressMap);
