...
/**
* Method to generate cadence code for MetadataViews contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const MetadataViewsTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `MetadataViews =>`)
...
/**
* Deploys MetadataViews transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployMetadataViews = async (props) => {
  const { addressMap = {} } = props;
  const code = await MetadataViewsTemplate(addressMap);
