...
/**
* Method to generate cadence code for NonFungibleToken contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const NonFungibleTokenTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `NonFungibleToken =>`)
...
/**
* Deploys NonFungibleToken transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployNonFungibleToken = async (props) => {
  const { addressMap = {} } = props;
  const code = await NonFungibleTokenTemplate(addressMap);
